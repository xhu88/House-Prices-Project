...
|--------------------|-------------------------|-------------------|
|RMSE:              |RMSE:                       | RMSE:  0.15325  (Submissions are evaluated on Root-Mean-Squared-Error (RMSE) between the logarithm of the predicted value and the logarithm of the observed sales price.      |
